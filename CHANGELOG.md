...
## [0.8.0] - 2025-04-22
### Added
- Added new functions: isValidFreeTextModule, getModuleSkins
### Changed
...
## [0.7.1] - 2025-04-22
### Added
- Added new utility function: updateFreeTextModule
- Added related tests
- Added related documentation

## [0.7.0] - 2025-04-21
### Added
- Added new utility functions: getSidebarModules, getFreeTextModule, getModuleSkins
- Added related tests
- Added related documentation
...
## [0.6.3] - 2025-04-06
### Fixed
- Fix isModifiedSkin prototype comparison
### Changed
- Adapt layout tests

## [0.6.1] - 2025-03-18
### Fixed
- Fix internal checkLoggedIn function
### Added
- Add validateLayout check for image functions

## [0.6.0] - 2025-03-16
### Added
- Add missing *this* to createSkin call
- Add layout image functionality to listImages, hasImage, updateImage, deleteImage, createImage
